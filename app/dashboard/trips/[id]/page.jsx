      ...
      <div className="min-h-screen bg-white dark:bg-zinc-950">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-[13.5px] font-semibold text-zinc-500 dark:text-zinc-400 hover:text-orange-600 dark:hover:text-orange-400 mb-6 transition"
          >
            ...
            <>
              ...
              <div className="flex flex-wrap gap-2 mb-10">
                {trip.interests?.map((i) => (
                  <span key={i} className="text-[12px] font-semibold text-orange-700 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/30 px-3 py-1 rounded-full">
                    {i}
                  </span>
                ))}
              </div>
                      ...
                      <div className="space-y-4">
                        {trip.aiResult.dailySchedule.map((day) => (
                          <div key={day.day} className="rounded-2xl border border-zinc-100 dark:border-zinc-800 p-4 sm:p-5">
                            <p className="text-[12px] font-bold text-orange-600 dark:text-orange-400 uppercase tracking-wide mb-3">Day {day.day}</p>
                      ...
                      <div className="grid sm:grid-cols-2 gap-2">
                        {trip.aiResult.packingChecklist.map((item, idx) => (
                          <div key={idx} className="flex items-center gap-2.5 text-[13.5px] text-zinc-600 dark:text-zinc-300 bg-zinc-50 dark:bg-zinc-900 rounded-lg px-3 py-2">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#EA580C" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 shrink-0">
