...
function SuccessContent() {
  ...
  return (
    <main className="max-w-lg mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <div className="text-center rounded-2xl border border-slate-200 dark:border-slate-800 px-6 sm:px-10 py-12 sm:py-14">
        <div
        ...
        {copy.lines.map((line) => (
          <p
            key={line}
            className="text-[13.5px] sm:text-[14px] text-slate-500 dark:text-slate-400 mb-1 last:mb-8"
          >
            {line}
          </p>
        ))}
        ...
        {sessionId && (
          <p className="text-[11.5px] text-slate-400 dark:text-slate-600 mb-8 break-all">
            Reference: {sessionId}
          </p>
        )}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            href="/pricing"
            className="inline-flex items-center justify-center gap-2 text-[14px] font-semibold px-6 py-3 rounded-xl w-full sm:w-auto border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900"
          >
            View Plans
          </Link>
        </div>
