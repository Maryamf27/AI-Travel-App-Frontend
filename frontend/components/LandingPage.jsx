    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-white/80 dark:bg-zinc-950/80 border-b border-zinc-100 dark:border-zinc-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          {anchorLinks.map((l) => (
            <a key={l} href={`#${l.toLowerCase()}`} className="text-[14px] font-medium text-zinc-600 dark:text-zinc-400 hover:text-purple-600 dark:hover:text-purple-400 transition">
              {l}
            </a>
          ))}
          <Link href="/pricing" className="text-[14px] font-medium text-zinc-600 dark:text-zinc-400 hover:text-purple-600 dark:hover:text-purple-400 transition">
            Pricing
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link href="/login" className="hidden sm:inline-block text-[14px] font-semibold text-zinc-700 dark:text-zinc-300 hover:text-purple-600 dark:hover:text-purple-400 transition">
            Log in
          </Link>
          <Link
            href="/signup"
  ...
  return (
    <section className="relative overflow-hidden">
      <div
        ...
        style={{ background: 'radial-gradient(60% 50% at 85% 10%, rgba(168,85,247,0.14) 0%, transparent 60%)' }}
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-16 sm:pb-24 grid lg:grid-cols-2 gap-10 lg:gap-16 justify-center items-center relative">
        <div>
          <div className={`inline-flex items-center gap-2 ${ACCENT_BG_SOFT} border ${ACCENT_BORDER_SOFT} rounded-full px-3.5 py-1.5 mb-5 sm:mb-6`}>
            ...
            <span className="text-[11.5px] sm:text-[12.5px] font-semibold text-purple-700 dark:text-purple-400">Enterprise Travel Platform</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 text-[14px] sm:text-[15px] font-semibold text-zinc-700 dark:text-zinc-300 px-2 py-3 sm:py-3.5 hover:text-purple-600 dark:hover:text-purple-400 transition"
            >
        ...
        <div className="relative h-80 sm:h-96 lg:h-105 hidden lg:block">
          <div
            className="absolute inset-0 rounded-[28px] border border-purple-100 dark:border-zinc-800 bg-cover bg-center"
            style={{ backgroundImage: "url('https://images.unsplash.com/photo-1763455892848-39bbc7ca90a0?auto=format&fit=crop&w=1200&q=80')" }}
          >
            <div className="absolute inset-0 rounded-[28px] bg-linear-to-br from-white/10 via-white/0 to-white/30 dark:from-zinc-950/40 dark:via-zinc-950/10 dark:to-zinc-950/50" />
          </div>
          ...
          <div className="absolute top-8 left-8 right-16 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-100 dark:border-zinc-800 p-5 -rotate-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[11px] font-bold bg-purple-50 dark:bg-purple-950/30 text-purple-700 dark:text-purple-400 px-2.5 py-1 rounded-full">Day 2 of 5</span>
            </div>
          ...
          <div className="absolute bottom-10 right-2 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-100 dark:border-zinc-800 p-4 w-52 rotate-3">
            ...
            <div className="h-1.5 rounded-full bg-zinc-100 dark:bg-zinc-800 overflow-hidden">
              <div className="h-full w-[92%] bg-purple-600 dark:bg-purple-600/80 rounded-full" />
            </div>
          ...
          <div className="absolute bottom-6 left-4 bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-zinc-100 dark:border-zinc-800 px-3.5 py-2.5 flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-purple-100 dark:bg-purple-950/40 flex items-center justify-center">
              <svg viewBox="0 0 24 24" fill="none" stroke="#A855F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
...
function ItineraryRow({ time, title, tag }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="text-[10.5px] font-semibold text-purple-700 dark:text-purple-400 bg-purple-50 dark:bg-purple-950/30 px-2 py-0.5 rounded-full shrink-0">{tag}</span>
    </div>
  );
}
    ...
    <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        {FEATURE_LIST.map((f) => (
          <div
            key={f.title}
            className="group rounded-2xl border border-zinc-100 dark:border-zinc-900 bg-gray-100 dark:bg-zinc-900/40 p-5 sm:p-6 hover:border-purple-300 dark:hover:border-purple-900/60 hover:shadow-lg transition"
          >
            <div className="w-10 h-10 rounded-[10px] bg-purple-50 dark:bg-purple-950/30 flex items-center justify-center mb-4 group-hover:bg-linear-to-r group-hover:from-cyan-500 group-hover:via-purple-500 group-hover:to-pink-600 dark:group-hover:from-cyan-600 dark:group-hover:via-purple-600 dark:group-hover:to-pink-700 transition">
...
function FeatureIcon({ name }) {
  const common = { viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.8, strokeLinecap: 'round', strokeLinejoin: 'round', className: 'w-5 h-5 text-purple-600 dark:text-purple-400 group-hover:text-white transition' };
  const paths = {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="grid sm:grid-cols-2 gap-5 sm:gap-6 max-w-7xl  ">
          {ROLES.map((r, i) => (
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-zinc-950/90 via-zinc-950/75 to-zinc-950/40" />
                ...
                <ul className="space-y-2.5">
                  {r.items.map((it) => (
                    <li key={it} className="flex items-start gap-2.5 text-[13.5px]">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 mt-0.5 shrink-0 text-purple-300">
...
function CtaBanner() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
      ...
      >
        <div className="pointer-events-none absolute inset-0 bg-linear-to-br from-[#1C0A03]/90 via-[#3B0764]/80 to-[#1C0A03]/90" />
        <div
          className="pointer-events-none absolute inset-0"
          style={{ background: 'radial-gradient(60% 80% at 50% 0%, rgba(168,85,247,0.35) 0%, transparent 60%)' }}
        />
        ...
        <Link
          href="/signup"
          className={`relative inline-flex items-center gap-2 ${BTN_GRADIENT} text-[14.5px] sm:text-[15px] font-bold px-6 sm:px-7 py-3 sm:py-3.5 rounded-xl shadow-[0_8px_24px_rgba(168,85,247,0.3)] dark:shadow-[0_8px_24px_rgba(219,39,119,0.2)]`}
        >
          Get started for free
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
            <path d="M5 12h14M13 6l6 6-6 6" />
    ...
    <footer className="border-t border-zinc-100 dark:border-zinc-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-[7px] bg-linear-to-r from-cyan-500 via-purple-500 to-pink-600 dark:from-cyan-600 dark:via-purple-600 dark:to-pink-700 flex items-center justify-center">
