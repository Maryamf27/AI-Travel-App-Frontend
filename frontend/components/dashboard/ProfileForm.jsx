  ...
  return (
    <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 p-6 sm:p-8 max-w-xl">
      <div className="flex items-center gap-3.5 mb-6">
        <div className="w-14 h-14 rounded-full bg-purple-100 dark:bg-purple-950/40 flex items-center justify-center text-xl font-bold text-purple-700 dark:text-purple-400 shrink-0">
