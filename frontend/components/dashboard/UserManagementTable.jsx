...
const ROLE_STYLES = {
  ...
  travel_agent: 'bg-purple-50 dark:bg-purple-950/30 text-purple-700 dark:text-purple-400',
    ...
    <div>
      ...
      <div className="relative mb-5 max-w-sm">
        ...
        <input
          ...
          className="w-full pl-10 pr-3.5 py-2.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[10px] text-[13.5px] outline-none focus:border-purple-600 focus:ring-4 focus:ring-purple-600/15 transition"
        />
      </div>
              ...
              <div key={u._id} className="px-5 py-4">
                ...
                <div className="flex sm:hidden items-start justify-between gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="w-9 h-9 rounded-full bg-purple-100 dark:bg-purple-950/40 flex items-center justify-center text-[13px] font-bold text-purple-700 dark:text-purple-400 shrink-0">
                ...
                <div className="hidden sm:grid grid-cols-[1.6fr_1.4fr_1fr_1fr_40px] gap-3 items-center">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-950/40 flex items-center justify-center text-[12px] font-bold text-purple-700 dark:text-purple-400 shrink-0">
                      {u.name?.[0]?.toUpperCase() || '?'}
                    </div>
