        ...
        {error && (
          <div className="mb-4 text-[13px] text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 rounded-lg px-3 py-2">
            ...
            {needsUpgrade && (
              <Link
                href="/pricing"
                className="block mt-2 text-purple-700 dark:text-purple-400 font-bold underline underline-offset-2"
              >
                Upgrade to Premium →
              </Link>
            )}
                ...
                return (
                  <button
                    ...
                    className={`text-[12.5px] font-semibold px-3 py-2 rounded-full border transition ${
                      active ? `${BTN_GRADIENT} border-transparent` : 'bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300 hover:border-purple-300 dark:hover:border-purple-900/50'
                    }`}
                  >
                    {interest}
                  </button>
