                ...
                <button
                  ...
                  className={`text-[12.5px] font-semibold px-3 py-2 rounded-full border transition disabled:opacity-60 ${
                    active
                      ...
                      : 'bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300 hover:border-purple-300 dark:hover:border-purple-900/50'
                  }`}
                >
                  {interest}
                </button>
