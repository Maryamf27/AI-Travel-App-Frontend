...
export default function RecommendationCard({ recommendation, onDelete }) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 p-5 hover:shadow-lg hover:border-purple-200 dark:hover:border-purple-900/50 transition">
      <div className="mb-3">
