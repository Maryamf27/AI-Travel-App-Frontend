...
export default function HotelHistoryCard({ search, onDelete }) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-300 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 p-5 hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-900/50 transition">
      <div className="mb-3">
