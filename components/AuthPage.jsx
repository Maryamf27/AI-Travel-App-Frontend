...
function AuthPageContent() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] bg-white dark:bg-zinc-950 transition-colors">
      {/* Brand Panel */}
      <div className="hidden lg:flex relative overflow-hidden flex-col justify-between p-10 xl:p-14 text-[#F5EFE9] bg-linear-to-br from-[#1C0A03] via-[#7C2D12] to-[#7C1D33]">
        <div
          className="pointer-events-none absolute inset-0 opacity-50"
          style={{ background: 'radial-gradient(120% 120% at 15% 0%, rgba(234,88,12,0.45) 0%, transparent 45%)' }}
        />
        <div className="relative flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-[9px] bg-linear-to-r from-orange-600 to-red-600 flex items-center justify-center">
          ...
          <span className="text-[17px] font-semibold text-white">
            Travel<span className="text-orange-400">AI</span>
          </span>
        </div>
        ...
        <div className="relative max-w-105">
          ...
          <h1 className="text-3xl xl:text-4xl font-semibold leading-tight text-white mb-4">
            Plan smarter.<br />Travel <span className="text-orange-400">safer.</span>
          </h1>
