...
export default function HotelSummary({ aiResult }) {
  ...
  return (
    <div className="rounded-2xl border border-orange-200 dark:border-orange-900/40 bg-orange-50 dark:bg-orange-950/30 p-5 sm:p-6 mb-6 sm:mb-8">
      ...
      {tips.length > 0 && (
        <div className="mt-4 pt-4 border-t border-orange-200 dark:border-orange-900/40">
          <p className="text-[11px] uppercase tracking-wide text-orange-700 dark:text-orange-400 font-semibold mb-2">Tips</p>
