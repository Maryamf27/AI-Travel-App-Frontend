...
export default function HotelCard({ hotel }) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 overflow-hidden hover:shadow-lg hover:border-orange-200 dark:hover:border-orange-900/50 transition flex flex-col">
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-1">
        <div className="flex items-start justify-between gap-2 mb-1.5">
          ...
          {rating !== null && (
            <span className="shrink-0 inline-flex items-center gap-1 text-[12px] font-bold text-orange-700 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/30 px-2 py-0.5 rounded-full">
        ...
        <div className="mt-auto pt-1">
          {detailsUrl ? (
            <a
              ...
              className="block w-full text-center text-[13px] font-semibold py-2.5 rounded-[10px] border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-200 hover:border-orange-300 dark:hover:border-orange-900/50 hover:text-orange-600 dark:hover:text-orange-400 transition"
            >
              View Details
            </a>
          ) : (
            <button
              ...
              className="w-full text-center text-[13px] font-semibold py-2.5 rounded-[10px] border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-200 hover:border-orange-300 dark:hover:border-orange-900/50 hover:text-orange-600 dark:hover:text-orange-400 transition"
            >
