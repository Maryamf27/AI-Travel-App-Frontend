...
export default function EmptyHotelState({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 py-16 px-4 text-center">
      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-teal-50 dark:bg-teal-950/30">
        <svg
          className="h-6 w-6"
          viewBox="0 0 24 24"
          fill="none"
