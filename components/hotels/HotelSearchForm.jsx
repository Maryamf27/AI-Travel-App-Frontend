...
const inputClass =
  'w-full px-3.5 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[10px] text-[14px] text-slate-900 dark:text-slate-50 placeholder-slate-400 dark:placeholder-slate-600 outline-none transition focus:border-teal-600 focus:ring-4 focus:ring-teal-600/15 disabled:opacity-60';
...
export default function HotelSearchForm({ onSuccess, onError }) {
  ...
  return (
    <form
      ...
      className="w-full max-w-4xl mx-auto bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-xl p-5 sm:p-7"
    >
