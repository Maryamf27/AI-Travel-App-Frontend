...
export default function VoiceAssistant() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-5 right-5 z-40 w-76 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-2xl overflow-hidden">
          ...
          <div className="p-4 flex flex-col items-center text-center">
            ...
            {(transcript || reply) && (
              <div className="w-full mt-3 text-left space-y-2">
                {transcript && (
                  <div className="text-[12.5px] px-3 py-2 rounded-lg bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-300">
                    <span className="font-semibold">You: </span>
                    {transcript}
                  </div>
                )}
                {reply && (
                  <div className="text-[12.5px] px-3 py-2 rounded-lg bg-teal-50 dark:bg-teal-950/30 text-slate-700 dark:text-slate-200">
